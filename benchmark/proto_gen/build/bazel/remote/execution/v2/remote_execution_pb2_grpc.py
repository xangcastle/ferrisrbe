...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in build/bazel/remote/execution/v2/remote_execution_pb2_grpc.py depends on'
    ...
    * contents: the plain text resource_name of the request message.
    ...
    def __init__(self, channel):
        ...
        self.GetTree = channel.unary_stream(
                ...
                _registered_method=True)
        self.SplitBlob = channel.unary_unary(
                '/build.bazel.remote.execution.v2.ContentAddressableStorage/SplitBlob',
                request_serializer=build_dot_bazel_dot_remote_dot_execution_dot_v2_dot_remote__execution__pb2.SplitBlobRequest.SerializeToString,
                response_deserializer=build_dot_bazel_dot_remote_dot_execution_dot_v2_dot_remote__execution__pb2.SplitBlobResponse.FromString,
                _registered_method=True)
        self.SpliceBlob = channel.unary_unary(
                '/build.bazel.remote.execution.v2.ContentAddressableStorage/SpliceBlob',
                request_serializer=build_dot_bazel_dot_remote_dot_execution_dot_v2_dot_remote__execution__pb2.SpliceBlobRequest.SerializeToString,
                response_deserializer=build_dot_bazel_dot_remote_dot_execution_dot_v2_dot_remote__execution__pb2.SpliceBlobResponse.FromString,
                _registered_method=True)
...
class ContentAddressableStorageServicer(object):
    ...
    * contents: the plain text resource_name of the request message.
    ...
    def SplitBlob(self, request, context):
    ...
    def SpliceBlob(self, request, context):
...
def add_ContentAddressableStorageServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'SplitBlob': grpc.unary_unary_rpc_method_handler(
                    servicer.SplitBlob,
                    request_deserializer=build_dot_bazel_dot_remote_dot_execution_dot_v2_dot_remote__execution__pb2.SplitBlobRequest.FromString,
                    response_serializer=build_dot_bazel_dot_remote_dot_execution_dot_v2_dot_remote__execution__pb2.SplitBlobResponse.SerializeToString,
            ),
            'SpliceBlob': grpc.unary_unary_rpc_method_handler(
                    servicer.SpliceBlob,
                    request_deserializer=build_dot_bazel_dot_remote_dot_execution_dot_v2_dot_remote__execution__pb2.SpliceBlobRequest.FromString,
                    response_serializer=build_dot_bazel_dot_remote_dot_execution_dot_v2_dot_remote__execution__pb2.SpliceBlobResponse.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
    ...
    * contents: the plain text resource_name of the request message.
    ...
    def SplitBlob(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/build.bazel.remote.execution.v2.ContentAddressableStorage/SplitBlob',
            build_dot_bazel_dot_remote_dot_execution_dot_v2_dot_remote__execution__pb2.SplitBlobRequest.SerializeToString,
            build_dot_bazel_dot_remote_dot_execution_dot_v2_dot_remote__execution__pb2.SplitBlobResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def SpliceBlob(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/build.bazel.remote.execution.v2.ContentAddressableStorage/SpliceBlob',
            build_dot_bazel_dot_remote_dot_execution_dot_v2_dot_remote__execution__pb2.SpliceBlobRequest.SerializeToString,
            build_dot_bazel_dot_remote_dot_execution_dot_v2_dot_remote__execution__pb2.SpliceBlobResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
